...
module.exports = {
	...
	generateMithrilJS: function ( path, jadeContent, jsTemplate, options, callback ) {
		options = options || {}
		...
		options = assign( { filename: path, pretty: true, context: true, prefix: jsParts[0], postfix: jsParts[1], indent_size: 1, indent_char: '\t' }, options )
