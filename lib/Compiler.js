...
Compiler = function (node, options) {
	return {
		compile: function () {
			var bufferExpression, depth, needsMap, normalizeAttributes, normalizeClassExpressions, parts, pretty, seenDepth0, toPush, visit, visitArgs, visitAttributes, visitBlock, visitCode, visitEach, visitNodes, visitTag, visitText;
